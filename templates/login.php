...
<?php if (isset($_SESSION['user_role'])) { ?>
    ...
    <a href="index.php?action=admin">
        <button type="submit" name="dashboard" class="btn btn-primary btn-raised">View Admin</button>
    </a>
    </div>
        ...
        <div id="admin" class="collapse">
            <form method="post" id="admin-login">
                <div class="form-group">
                    <input type="hidden" name="id" value="<?= $_SESSION['id'] ?>">
                    <label for="username" class="bmd-label-floating">Username</label>
                    <input type="text" id="username" name="txt_admin_username" placeholder="Username is: Antonio" class="form-control">
                </div>
                <div class="form-group">
                    <label for="email_log" class="bmd-label-floating">Email address</label>
                    <input type="email" id="email_log" name="txt_admin_uname_email" placeholder="Email is: antonio@admin.com" class="form-control">
                </div>
                <br>
                <div class="form-group">
                    <label for="pass_log" class="bmd-label-floating">Password</label>
                    <input type="password" id="pass_log" class="form-control" placeholder="Password is: antivirus" name="txt_admin_password">
                </div>
